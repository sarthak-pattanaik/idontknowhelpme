...
const SignupPage: React.FC = () => {
  ...
  const onOtpSubmit = (data: OtpFormValues) => {
    verifyOtp({ email, otp: data.otp }, {
      onSuccess: (response) => {
        ...
        // Existing user will be taken to product selection page
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-gray-50">
      <Helmet>
        <title>Sign Up | idontknowhelpme</title>
        <meta
          name="description"
          content="Create a new idontknowhelpme account and get access to our suite of AI-powered tools."
        />
      </Helmet>
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Join idontknowhelpme and get started with our AI tools</p>
        </div>
